...
// Proxy BFF hacia el backend de Combustible. Inyecta el bearer desde la cookie
// httpOnly server-side; el navegador nunca ve el token.
export const { GET, POST, PUT, PATCH, DELETE } = crearProxyBackend({
  destino: () => URLS_SERVIDOR.combustible,
  nombre: "combustible",
})
