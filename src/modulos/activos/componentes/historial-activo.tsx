...
const CAMPOS_HISTORIAL: Record<string, string> = {
  ...
  "vehiculo.ejes": "Ejes",
  "vehiculo.cantidadRuedas": "Ruedas",
  "vehiculo.categoria": "Categoria",
  "vehiculo.serieChasis": "Serie de chasis",
  "vehiculo.serieMotor": "Serie de motor",
  "vehiculo.gps": "GPS",
  "vehiculo.telemetria": "Telemetría",
  "vehiculo.radioBase": "Radio base",
  "vehiculo.adas": "ADAS",
  "vehiculo.adasAntapaccay": "ADAS Antapaccay",
  "vehiculo.adasQuellaveco": "ADAS Quellaveco",
  "vehiculo.proveedorAdas": "Proveedor ADAS",
  "vehiculo.estadoOperativo": "Condicion activo",
  "vehiculo.estadoCalibracion": "Estado de calibracion",
  "vehiculo.ancho": "Ancho",
  "vehiculo.longitud": "Longitud",
  "vehiculo.alto": "Alto",
  "vehiculo.pesoBruto": "Peso bruto (kg)",
  "vehiculo.pesoNeto": "Peso neto (kg)",
  "vehiculo.cargaUtil": "Carga util (kg)",
