...
import { useResumenSolicitudesQuery } from "../servicios/solicitudes-cliente-queries";
import type {
...
type Props = {
  // Contexto activo: de aca salen los filtros del resumen (origen/busqueda) y
  // el bucket resaltado.
  filtros: FiltrosSolicitudesCliente;
  // null = deseleccionar (clic en el bucket ya activo → listado sin filtro).
  onSeleccionar: (bucket: BucketSolicitudCliente | null) => void;
};
...
const TARJETAS: DefTarjeta[] = [
  ...
  },
  {
    ...
    descripcion: "Con cotización viva",
    icono: FilePen,
...
export function SolicitudesClienteKpis({ filtros, onSeleccionar }: Props) {
