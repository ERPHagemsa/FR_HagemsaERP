      ...
      <section className="w-full rounded-xl border border-border bg-card text-card-foreground">
        <div className="border-b border-border px-5 py-4">
          ...
          <p className="text-sm text-muted-foreground">
            Completa los datos que identifican al proveedor y permiten ubicarlo en la operacion.
          </p>
        </div>
          ...
          <form onSubmit={(event) => void registrar(event)}>
            <FieldGroup>
              ...
              <FieldSet className="rounded-lg border border-border p-4">
                ...
                <FieldDescription>
                  Nombre y departamento del contacto principal donde coordinamos con el proveedor.
                </FieldDescription>
                <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                  ...
                  <Field>
                    <FieldLabel htmlFor="referenciaContacto">Departamento o cargo en proveedor</FieldLabel>
                    <CatalogoSelect
