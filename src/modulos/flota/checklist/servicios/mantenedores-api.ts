...
// Capa de datos de los mantenedores/catálogos del checklist (tipos, kits,
// colores de rotulación, plantillas) para el NAVEGADOR. Mismo estandar que
// `asignaciones-api.ts`: fetch directo con `clienteFlota` (sin JWT), paths
// relativos al backend de Flota (`/flota/<recurso>`).
...
// blanco (sin respuestas) — mismo motor de impresión que un checklist real.
